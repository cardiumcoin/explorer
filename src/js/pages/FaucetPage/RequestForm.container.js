            ...
            <Formik
                ...
                render={({errors, touched, dirty, isSubmitting, isValidating, validateForm, isValid}) => (
                    <Form>
                        ...
                        <label className="basic500 margin6 fs12">Fill out your {this.props.networkName} address to receive {this.props.amount} CARDIUM</label>
                        ...
                        <button className="submit big long get-waves-btn" type="submit" disabled={!isValid || isSubmitting || isValidating}>
                            <span>Request {this.props.amount} CARDIUM</span>
                        </button>
                    </Form>
                )}
            />
